...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'M1zzle', // 您的昵称 例如 tangly1024
  ...
  GREETING_WORDS:
    ...
    'Welcome to My Corner.,Knowledge should be free.,Your Curiosity is an Anomaly in the Local Universe.',
