...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'M1zzle', // 您的昵称 
  BIO: process.env.NEXT_PUBLIC_BIO || '致虚极，守静笃', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://addtao.com', // 网站地址
  ...
  GREETING_WORDS:
    ...
    'Welcome to the museum of myself.', '欢迎来到我的自我博物馆。', 'Step into the gallery of my soul.', 'Enter the archive of my essence.', '进入我本质的档案馆。', 'Discover the chronicles of my being.',
    '发现我存在的编年史。',
